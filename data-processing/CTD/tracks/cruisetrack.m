% Programme de la route de la campagne PIRATA-FR30
%
...
% ---------------------------------------------------------
latmin = -25; latmax = 40; latint = 5;
lonmin = -45; lonmax = 15; lonint = 10;
...
m_line( HMtoH(-25), HMtoH(16.53), 'LineStyle', 'none','marker','o',...
    'markersize',markersize_VILLE,'color','k','markerfacecolor','k');
m_text( -25, 18,'Mindelo','vertical','middle', 'Fontsize', [11]);
...
m_line( HMtoH(-10), HMtoH(-6), 'LineStyle', 'none','marker','o',...
    'markersize',markersize_MOUILLAGE,'color','k','markerfacecolor','r');  
m_line( HMtoH(-10), HMtoH(-20), 'LineStyle', 'none','marker','o',...
    'markersize',markersize_MOUILLAGE,'color','k','markerfacecolor','r');
...
[st,date,heure,~,~,lat,lats,lon,lons,depth,~,~] = ...
   textread(FileStaPos,'%d %s %s %s %s %s %s %s %s %d %s %s','headerlines',1);
...
% -----------------------------------------
m_line( -10.5, 26,'LineStyle', 'none','marker','o','markersize',5,'color','k','markerfacecolor','b');
m_text( -9.5, 26,'Profils CTD','vertical','middle', 'Fontsize', [12]);
m_line( -10.5, 24,'LineStyle', 'none','marker','o','markersize',5,'color','k','markerfacecolor','g');
m_text( -9.5, 24,'Profils XBT','vertical','middle', 'Fontsize', [12]);
m_line( -10.5, 22,'LineStyle', 'none','marker','o','markersize',5,'color','k','markerfacecolor','r');
m_text( -9.5, 22,'Mouillages PIRATA','vertical','middle', 'Fontsize', [12]);
