% Programme de la route de la campagne PIRATA-FR27
%
...
% % -------------------------------------------------
% [st,date,heure,lat,lats,lon,lons,depth,type,t] = ...
 %   textread(FileStaPos,'%d %s %s %s %s %s %s %d %s %s','headerlines',2);
%    
% 
% % Conversion lat et lon en degre decimaux
% % -------------------------------------------
...
% trace en X (long) Y (lat) des legendes
% -----------------------------------------
...
m_line( -10.5, 25,'LineStyle', 'none','marker','o','markersize',5,'color','k','markerfacecolor','g');
m_text( -9.5, 25,'Profils XBT   900 m','vertical','middle', 'Fontsize', [12]);
