...
%
if p.use_buc
    data.u_buc_int    = interp1(data.tim_buc,data.u_buc,di.time_jul);
    data.v_buc_int    = interp1(data.tim_buc,data.v_buc,di.time_jul);
    data.dist_buc_int = interp1(data.tim_buc,data.dist_buc,di.time_jul);
    data.tim_buc_int  = interp1(data.tim_buc,data.tim_buc,di.time_jul);
    data.lon_buc_int  = interp1(data.tim_buc,data.lon_buc,di.time_jul);
    data.lat_buc_int  = interp1(data.tim_buc,data.lat_buc,di.time_jul);
    
    di.u_buc     = data.u_buc_int;
    di.v_buc     = data.v_buc_int;
    di.dist_buc  = data.dist_buc_int;
    di.lon_buc   = data.lon_buc_int;
    di.lat_buc   = data.lat_buc_int;
    di.tim_buc   = data.tim_buc_int;
end
