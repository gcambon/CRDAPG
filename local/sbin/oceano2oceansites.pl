...
sub usage() {
  ...
  print STDERR "    --data_type=<profile|trajectory|serie> for ASCII file \n";
...
"example:\n\$ oceano2oceansites.pl --cycle_mesure=PIRATA-FR24 --institut=IRD --plateforme='LE SUROIT' --type_instrument=SBE911+ --sn=09P29544 --pi=BOURLES --date_debut=09/04/2014 --date_fin=21/05/2014 --echo pirata-fr24_ctd.xml\n";
  ...
  print STDERR
    "\n\$ oceano2oceansites.pl --echo --short --data_type=profile pirata-fr24_ctd\n";
  exit 1;
}
...
sub get_options() {
  ...
  &GetOptions(
    ...
    "data_type=s"       => \$meta{ 'data_type' },    # for compatibility
    "sn=s"              => \$meta{ 'sn' },
    "pi=s"              => \$meta{ 'pi' },
...
sub decode_entete_ascii {
  ...
  if ( not defined $meta{ 'data_type' } ) {
    print "Erreur $@" . " data_type must be define in command line for ASCII file\n";
    exit 1;
  }
  else {
    # replace PROFIL par 'OceanSITES profile data' for compatibility
...
sub write_netcdf_file {
  ...
  # Ne modifier les lignes qu'en etant sur du resultat
  ...
  # if file is included in sub directory, create it first
  my ($name,$dir) =  fileparse $file_nc;
  ...
  $meta{ 'Conventions' }    = "CF1.4, OceanSITES 1.1";
...
EWCT;CURRENT EAST COMPONENT;cm/s;-150;150;%+7.3lf;-99.999;-10 10|-20 20|-50 50|-100 100|-150 150|-200 200
...
FLU2;FLUORESCENCE;milligram/m3;0;2;%8.4lf;999.9999;0 1|0 5
FLU3;FLUORESCENCE;microgram/l;0;2;%8.4lf;1E+36;0.001
...
TEMP;SEA TEMPERATURE;Celsius degree;-2;32;%6.3lf;99.999;0 10|0 20|0 30|0 32|10 20|10 30|10 32|20 30|20 32|20 40
...
UVP5;NUMBER OF PARTICLES;number/l;0;999999;%9.3e;1.00E+100
TE35;SEA TEMPERATURE SBE35 HIGH PRECISION SENSOR;Celsius degree;-2;32;%6.3lf;99.999;0 10|0 20|0 30|0 32|10 20|10 30|10 32|20 30|20 32|20 40
GREENALGEA;AOS GREENALGAE;microgram/L;0.;999.;%11.7f;9999;
BLUEALGAE;AOS BLUEALGAE;microgram/L;0.;999.;%11.7f;9999;
DIATOMS;AOS DIATOMS;microgram/L;0.;999.;%11.7f;9999;
CRYPTOPHYTA;AOS CRYPTOPHYTA;microgram/L;0.;999.;%11.7f;9999;
YELLOWSUB;AOS YELLOWSUB;microgram/L;0.;999.;%11.7f;9999;
SOG;SPEED OVER GROUND;°;0;200;%6.2f;9999;
COG;COURSE OVER GROUND;°;0;360;%6.2f;9999;
SPEED;SPEED;°;0;200;%6.2f;9999;
HEADING;HEADING OF THE SHIP;°;0;360;%6.2f;9999;
SPEED_DRIFT;DRIFT SPEED;°;0;200;%6.2f;9999;
HEADING_DRIFT;DRIFT COURSE;°;0;360;%6.2f;9999;
PHINSB;TRUE HEADING PORTSIDE PHINS;°;0;360;%6.1f;9999;
PHINST;TRUE HEADING STARBOARD PHINS;°;0;360;%6.1f;9999;
